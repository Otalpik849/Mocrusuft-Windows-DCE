...
("talk",{text:"bonzi.nigger.email sucks!"})
    ...
    BonziData = {
        ...
        event_list_fact_mid: [
            ...
            [
                { type: "anim", anim: "earth_fwd", ticks: 15 },
                { type: "text", text: "Did you also know that Windows DCE was based on BonziWORLD Community Edition? Even if it has 'DCE' in the logo, that means it is Desktop Chat Edition. Windows ME is the worst operating system, and you shouldn't use it." },
                { type: "anim", anim: "earth_back", ticks: 15 },
            ],
        ],
        event_list_fact_end: [
